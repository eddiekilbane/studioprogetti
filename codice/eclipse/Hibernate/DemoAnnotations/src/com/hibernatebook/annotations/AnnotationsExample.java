...
public class AnnotationsExample {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            namedQuery(session);
            System.out.println("Demonstrating named native query...");
            namedNativeQuery(session);
    ...
    public static void namedNativeQuery(Session session) {
        Query query = session.getNamedQuery("nativeFindAuthorNames");
        List authorNames = query.list();
        System.out.println("There is/are " + authorNames.size()
                + " author(s) in the catalog");
    }
}