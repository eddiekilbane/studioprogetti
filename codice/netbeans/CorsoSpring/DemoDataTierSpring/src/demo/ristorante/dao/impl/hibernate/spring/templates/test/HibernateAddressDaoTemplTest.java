...
package demo.ristorante.dao.impl.hibernate.spring.templates.test;
 ...
 * @author stefano
 */
public class HibernateAddressDaoTemplTest {
    ...
    public static void main(String[] args) {
        ...
        Resource resource = new ClassPathResource("config/hibernate/templates/HibernateDaoSupportTemplate.xml");
