...
<title>Essence by Free Css Templates</title>
...
<body>
<%
model.Utente utente = (model.Utente)request.getAttribute("utente"); 

%>


<div id="header">
	<h1><a href="#">Essence</a></h1>
	<h2><a href="http://www.freecsstemplates.org/">By Free CSS Templates</a></h2>
</div>
<div id="page">
	<div id="content">
		<div id="welcome" class="post">
			<h1 class="title">Welcome <%=utente.getNome() %> !</h1>
		...
		<div id="updates" class="boxed">
			...
			<div class="content">
				<ul>
					...
					<li>
						<h3>March 13, 2007</h3>
						<p><a href="#">Quisque dictum integer nisl risus, sagittis convallis, rutrum id, and nibh&#8230;</a></p>
					</li>
				</ul>
			</div>
		</div>
