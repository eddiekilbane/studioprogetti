...
<link rel="stylesheet" href="http://localhost:8080/DemoTransazioni/stile/style.css" type="text/css" charset="utf-8" />
</head>
<body>
<%
                  ...
                  <div class="box-br">
                    <div class="box-bl">
                      <div class="box-tl">
                        ...
                        <input type="hidden" name="idProdotto" value=<%=trovato.getPrimaryKey() %>>
						<table border="1">
						<tr>
						<td>TITOLO</td><td><input type="text" name="txtTitle" value=<%=trovato.getTitle() %> /></td>
						</tr>
						<tr>
						<td>ARTISTA</td><td><input type="text" name="txtArtist" value=<%=trovato.getArtist() %>  /></td>
						</tr>
						<tr>
						<td>PREZZO</td><td><input type="text" name="txtPrice" value=<%=trovato.getPrice() %> /></td>
						</tr>
						<tr>
						<td>NAZIONE</td><td><input type="text" name="txtCountry" value=<%=trovato.getCountry() %> /></td>
						</tr>
						<tr>
						<td>ETICHETTA</td><td><input type="text" name="txtCompany" value=<%=trovato.getCompany() %>  /></td>
						</tr>
						<tr>
						<td>ANNO</td><td><input type="text" name="txtAnno" value=<%=trovato.getYear() %>  /></td>
						</tr>
						<tr>
						<td>QUANTITA</td><td><input type="text" name="txtQuantity" value=<%=trovato.getQuantity() %> /></td>
						</tr>
						<tr>
						<td><input type="submit" value="Conferma modifica"  /></td><td><input type="reset"  /></td>
						</tr>
						</table>
						</form>
                      </div>
