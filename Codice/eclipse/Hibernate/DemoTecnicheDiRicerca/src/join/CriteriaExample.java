...
public class CriteriaExample {
	...
	public void executeOneToManyAssociationsCriteria(Session session) {
		Criteria CrtSupplier = session.createCriteria(Supplier.class).createAlias("products", "prod");
		//Criteria prdCrit = crit.createCriteria("products");
		Criterion nomeFornitore=Restrictions.eq("name", "MegaInc");
		Criterion nomeProdotto=Restrictions.eq("prod.name", "Mouse");
		CrtSupplier.add(Restrictions.or(nomeFornitore, nomeProdotto));
		List results = CrtSupplier.list();
	...
	public static void main(String args[]) {
		...
		example.executeOneToManyAssociationsCriteria(session);
