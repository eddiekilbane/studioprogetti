package demo.associations.ManyToMany.unidirectional.beans;
...
public class User implements Serializable {
	...
	private Set indirizzi = new HashSet();
    ...
    public void addIndirizzo (Address indirizzo){
        indirizzi.add(indirizzo);
    }

     public void removeIndirizzo (Address indirizzo){
