...
<link rel="stylesheet" href="stile/style.css" type="text/css" charset="utf-8" />
</head>
<body>
<div id="wrapper">
                  ...
                  <div class="box-br">
                    <div class="box-bl">
                      <div class="box-tl">
                        <h2>CERCA CD</h2>
                        <h3>Campi ricerca</h3>
                        <form action="servlet/ServletRicerca">
						<table border="1" style=" width : 314px;">
						<tr>
						<td>TITOLO</td><td><input type="text" name="txtTitle"  /></td>
						</tr>
						<tr>
						<td>ARTISTA</td><td width="162"><input type="text" name="txtArtist"  /></td>
						</tr>
						<tr>
						<td>PREZZO</td><td><input type="text" name="txtPrice"  /></td>
						</tr>
						<tr>
						<td>NAZIONE</td><td><input type="text" name="txtCountry"  /></td>
						</tr>
						<tr>
						<td>ETICHETTA</td><td><input type="text" name="txtCompany"  /></td>
						</tr>
						<tr>
						<td>ANNO</td><td><input type="text" name="txtYear"  /></td>
						</tr>
						<tr>
						<td>QUANTITA</td><td><input type="text" name="txtQuantity"  /></td>
						</tr>
						<tr>
						<td><input type="submit" value="Ricerca"  /></td><td><input type="reset"  /></td>
						</tr>
						</table>
						</form>
                      </div>
