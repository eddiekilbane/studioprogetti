...
public final class UpdateCD_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"/stile/style.css\" type=\"text/css\" charset=\"utf-8\" />\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");

java.util.List lista = (java.util.List)session.getAttribute("lista");
demo.transazioni.beans.CD trovato = (demo.transazioni.beans.CD)lista.get(1); 
      ...
      out.write("                        <h3>movie hits</h3>\r\n");
      out.write("                        <form action=\"ServletUpdate\">\r\n");
      out.write("                        <input type=\"hidden\" name=\"idProdotto\" value=");
      out.print(trovato.getPrimaryKey() );
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t<table border=\"1\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>TITOLO</td><td><input type=\"text\" name=\"txtTitle\" value=");
      out.print(trovato.getTitle() );
      out.write(" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>ARTISTA</td><td><input type=\"text\" name=\"txtArtist\" value=");
      out.print(trovato.getArtist() );
      out.write("  /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>PREZZO</td><td><input type=\"text\" name=\"txtPrice\" value=");
      out.print(trovato.getPrice() );
      out.write(" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>NAZIONE</td><td><input type=\"text\" name=\"txtCountry\" value=");
      out.print(trovato.getCountry() );
      out.write(" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>ETICHETTA</td><td><input type=\"text\" name=\"txtCompany\" value=");
      out.print(trovato.getCompany() );
      out.write("  /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>ANNO</td><td><input type=\"text\" name=\"txtAnno\" value=");
      out.print(trovato.getYear() );
      out.write("  /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>QUANTITA</td><td><input type=\"text\" name=\"txtQuantity\" value=");
      out.print(trovato.getQuantity() );
      out.write(" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"submit\" value=\"Conferma modifica\"  /></td><td><input type=\"reset\"  /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("                      </div>\r\n");
