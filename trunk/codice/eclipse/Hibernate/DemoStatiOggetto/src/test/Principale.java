...
public class Principale {
	...
	public static void main (String [] args){
		...
		beans.CD trovato =(beans.CD)sessione.load("beans.CD", (java.io.Serializable)id);
        System.out.println();
		System.out.println();
		System.out.println();
        ...
        beans.CD aggiornato =(beans.CD)sessione.load("beans.CD", (java.io.Serializable)id);
