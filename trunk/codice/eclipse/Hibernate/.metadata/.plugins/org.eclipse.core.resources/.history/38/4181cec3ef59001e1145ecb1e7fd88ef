package demo.associations.OneToMany.unidirectional.test;
import org.hibernate.Session;
import org.hibernate.SessionFactory;
import org.hibernate.cfg.Configuration;

import demo.associations.OneToMany.unidirectional.beans.*;
...
private SessionFactory sessionFactory;
	...
	public static void main(String[] args) {
		...
		System.out.println("Costruzione utente..");
		...
		System.out.println("Costruzione address..");
