...
<table border="1" width="100%">
  ...
  <tr>
    ...
    Application Name: <bean:write name="name"/><BR>
     ...
     Server Info: <bean:write name="context" property="serverInfo" format="0"/><BR>
     <bean:define id="context_copy" name="context"
                  type="javax.servlet.ServletContext"/>
     Server Major Version:
              <bean:write name="context_copy" property="minorVersion" format="0"/>
</td>
</tr>
<%--
...
<% HashMap lines = new HashMap();
    ...
    Line Count: <bean:write name="length" format="0"/>
</td>
</tr>
<%--
...
<%
  ...
  This should not be in <bean:write name="bs" format="0" />bold
                        <bean:write name="be" format="0" /><BR>
  This should be in <bean:write name="bs" filter="false" format="0"/>bold
                    <bean:write name="be" filter="false" format="0" /><BR>
</td>
</tr>
</table>
</body>
