...
public class Data
{
       ...
       public Data (int g,int mese , int anno)throws Exception
       {
       ...
       public int confrontaDate (Data d)
       {
       	      int compara=1;
       ...
       //doppione di compareTo che rende Data Comparable
       /*
       ...
       */
       ...
       public int differenzaDate (Data d)
       {
